    ...
    <div class="custom-container">
        <ul class="range-ul">
            ...
            <li class="dropdown">
                ...
                <form action="{{route('user.front-services')}}" method="get" id="form_search">

                    <input type="hidden" name="available_now" id="available_now">
            ...
            <li><a href="#" onclick="submitFunction('available_now',null)"><i class="far fa-clock"></i>Available Now</a></li>
            ...
            @if(Auth::check())
                <li>
                    ...
                    <a href="#" onclick="submitFunction('posted_by_me',null)"
                       @if(app('request')->input('posted_by')== "me") style="border:1px solid #aaaaaa" @endif> Posted By
                        Me</a>
                </li>
            @endif
            <li class="dropdown">
            ...
            <li><a href="{{route('user.front-services')}}"><i class="fas fa-redo"></i></a></li>
            <li><a href="{{route('user.add-service')}}">Post Service</a></li>

        </ul>
        <a href="#" onclick="loadScript(mapResult)" type="button" data-toggle="dropdown" class="show-map dropdown">Show Map <i
...
<script>
    ...
    function submitFunction(value,type) {
        ...
        @if(isset($_GET['available_now']) != '')
            $('#available_now').val('{{$_GET['available_now']}}');
        @endif
