        ...
        <div class="container top-search-main">
            <div class="row">
                <div class="ts-menu">
                    ...
                    <div class="ts-menu-2"><a href="#" class="t-bb">All Pages <i class="fa fa-angle-down"
                                                                                 aria-hidden="true"></i></a>
                        <!--SECTION: BROWSE CATEGORY-->
                        <div class="cat-menu cat-menu-1" style="display: none;">
                            <div class="dz-menu">
                                <div class="dz-menu-inn">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="price.html">Listing</a></li>
                            ...
                            <div class="dir-home-nav-bot">
                                <ul>
                                    ...
                                    <li><a href="advertise.html" class="waves-effect waves-light btn-large"><i
                                                    class="fa fa-bullhorn"></i> Advertise with us</a></li>
                                    <li><a href="db-listing-add.html" class="waves-effect waves-light btn-large"><i
                                                    class="fa fa-bookmark"></i> Add your business</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            <form class="tourz-search-form tourz-top-search-form">
                                ...
                                <div class="input-field">
                                    ...
                                    <label for="top-select-search" class="search-hotel-type">Search your services like
                                        hotel, resorts, events and more</label>
                                    <ul class="autocomplete-content dropdown-content"></ul>
                                </div>
                                <div class="input-field">
                                    <i class="waves-effect waves-light tourz-top-sear-btn waves-input-wrapper" style=""><input
                                                type="submit" value="" class="waves-button-input"></i></div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="ts-menu-4">
                        <div class="v3-top-ri">
                            <ul>
                               <li><a href="@if(Auth::check()) {{route('logout')}} @else {{route('login')}} @endif" class="v3-menu-sign"><i class="fa fa-sign-in"></i> @if(Auth::check()) Logout @else  Login @endif</a>
                                </li>
                    ...
                    <div class="mob-right-nav" data-wow-duration="0.5s">
                        ...
                        <ul>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Help
                                    Services</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Appliances
                                    Repair &amp; Services</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Furniture
                                    Dealers</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Packers and
                                    Movers</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Pest Control
                                </a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Solar Product
                                    Dealers</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Interior
                                    Designers</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Carpenters</a>
                            </li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Plumbing
                                    Contractors</a></li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Modular Kitchen</a>
                            </li>
                            <li><a href="list.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Internet
