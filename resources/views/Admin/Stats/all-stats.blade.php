...
@section('content')
    ...
    <div class="body-container">
        @include('admin.Stats.Partials.all-stats-menu-partial')
        <div class="right-rable-main">
            ...
            <form id="form_submit_onchange" method="get"
                ...
                <div class="search-drop-down-main">
                    ...
                    <div class="search-left">
                        ...
                        <input type="text" name="search" value="{{ old('search') }}" placeholder="By Stat Name"
                               name="search">
            ...
            @if($data['all_stats']['all_stats_count'] > 0)
                <div class="table-sec-main">
                    ...
                    <span class="pagination-text">Showing
                        ...
                        @if($data['all_stats']['total_stats']->total() > 5 )
                            {{$data['all_stats']['all_stats']->firstItem()}}
                            - {{$data['all_stats']['total_stats']->lastItem()}}
                            of {{$data['all_stats']['all_stats_count']}}
                        ...
                        @endif  </span>
                            @if(!app('request')->input('sort_by'))
                                {{$data['all_stats']['all_stats']->links()}}
                            @else
                                {{$data['all_stats']['all_stats']->appends(['sort_by' => app('request')->input('sort_by')])->links()}}
                            @endif
                        </div>
                    </div>
                    ...
                    @foreach($data['all_stats']['all_stats'] as $stat)
                            ...
                            <div class="start-table-main">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span
                                                        class="customer-id">Stat Title</span>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                        class="custom-right-text">@if($stat->is_active == 1)
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">{{$stat->id}}</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span class="customer-id">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">{{$stat->description}}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span
                                                        class="customer-id"> Image</span>
                                            </div>
                                            <div class="col-md-7 col-sm-6 col-6" style="height:100px;width: 100px;">


                                                    <img style="height: 100px;width:100px;" src="{{$stat->image}}">
                                ...
                                <ul class="table-icon-ul">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('admin.delete-stat',[$stat->id])}}">Delete Stat</a>
                                            </li>
                                            @if($stat->is_active == 1)
                                                <li><a href="{{route('admin.change-status.stat',[$stat->id])}}">Deactive</a></li>
                                            @endif
                                            @if($stat->is_active == 0)
                                                <li><a href="{{route('admin.change-status.stat',[$stat->id])}}">Active</a></li>
                                            @endif
                    ...
                    @endforeach
                    <span class="showing-text">{{$data['all_stats']['all_stats']->firstItem()}}
                        - {{$data['all_stats']['total_stats']->lastItem()}}
                        of {{$data['all_stats']['all_stats_count']}} </span>
                </div>
            @endif
