    ...
    <div class="body-container">
        ...
        <div class="right-rable-main">
            ...
            <form id="form_submit_onchange" method="get"
                  action="{{route('admin.all-business')}}">
                ...
                <div class="table-sec-main">
                    <div class="table-first-sec">
                        <ul class="table-left-ul">
                            ...
                            <li>
                                <a href="{{route('admin.approve-all-businesses')}}" class="send-main-btn"> Approve All Businesses</a>
                            </li>
                        </ul>
                        ...
                        <div class="start-table">
                            <div class="start-table-main">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('admin.business.detail',[$business->id])}}">{{$business->title}}</a>
                                            </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">
                                                    {{$business->address->first()->country->name}} ,



                                                    {{$business->address->first()->city->name}}
                                         </span></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span class="customer-id">
                                ...
                                <ul class="table-icon-ul">
                                    <li><a href="{{route('admin.business.detail',[$business->id])}}"><i class="far fa-eye" title="view details"></i></a></li>
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            @if($business->is_approve == 'Not Approve')
                                                <li> <a href="{{route('admin.approve-business',[$business->id])}}">
                                                        Approve Business
                                                    </a></li>
                                                <li> <a href="{{route('admin.reject-business',[$business->id])}}">
                                                        Reject Business
                                                    </a></li>
                                            @endif
