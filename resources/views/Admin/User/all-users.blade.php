...
@section('content')
    ...
    <div class="body-container">
        @include('Admin.User.Partials.all-users-menu-partial')
        <div class="right-rable-main">

            <form id="form_submit_onchange" method="get"
                  action="{{route('admin.all-users')}}">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">
                                                    @if($user->role->name == 'Agent')
                                                        Adds ({{$user->agentAdminAdds()->count()}})
                                                        Services ({{$user->agentAdminServices()->count()}}),
                                                        Business ({{$user->agentAdminBusinesses()->count()}})
                                                    @else
