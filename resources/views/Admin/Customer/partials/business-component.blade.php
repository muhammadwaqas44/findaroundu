                            ...
                            <ul class="table-icon-ul">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{route('admin.delete-business',[$business->id])}}">Delete</a></li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="pagination-top-main">
                                            <span class="pagination-text">Showing
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{route('admin.all-business',['user_id' => $data['user_detail']->id])}}" class="btn btn-primary">Show more</a>
