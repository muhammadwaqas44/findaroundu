                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-6 col-6">
                                            <span class="custom-right-text">
                                                <a href="{{route('admin.subscription.subscription-detail',[$subscription->id])}}">{{$subscription->name}}</a>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-6 col-6"><span
                                                ...
                                                <a href="{{route('admin.plan-detail',[$subscription->plan->id])}}">{{$subscription->plan->name}}</a></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-6 col-6"><span
                                                    class="custom-right-text">
                                                <a href="{{route('admin.user-detail',[$subscription->subscriber->id])}}">{{$subscription->subscriber->name}}</a></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-6 col-6"><span
                                                    class="custom-right-text">
@if(!empty($subscription->user->address->country))
                                                    {{$subscription->user->address->country->name}}
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-sm-6 col-6"><span
                                                    class="customer-id">Total Price</span>
                                        </div>
                                        <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">
                                                    @if($subscription->total_price != null)
...
Free
                            ...
                            <ul class="table-icon-ul">
                                <li>
                                    <a href="{{route('admin.subscription.subscription-detail',[$subscription->id])}}"><i
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            @if($subscription->is_approve == 'Not Approve')
                                                <a href="{{route('admin.approve-add',[$subscription->id])}}">Approve
                                                    Add</a>
                                                <a href="{{route('admin.reject-add',[$subscription->id])}}">Reject
                                                    Add</a>
                                            @endif
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{route('admin.subscription.delete-subscription',[$subscription->id])}}">Delete</a>
                                        </li>
                ...
                <div class="table-first-sec">
                    ...
                    <span class="pagination-text">Showing
                        ...
                        @else
                            ...
                            <a href="{{route('admin.all-subscribers',['user_id' => $data['user_detail']->id])}}"
                               class="btn btn-primary">All Subscription
