<div class="menu-setup-right2">
    ...
    @if($data['all_services']['all_services_count'] < 5)
                    ...
                    <div class="pagination-top-main">
                                            <span class="pagination-text">Showing
                                                ...
                                                @if($data['all_services']['all_services_count'] == 0 )
                                                    0
                                                    - {{$data['all_services']['all_services_count']}}
                            ...
                            <ul class="table-icon-ul">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{route('admin.delete-service',[$service->id])}}">Delete</a></li>
                    ...
                    <div class="pagination-top-main">
                                            <span class="pagination-text">Showing
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{route('admin.services',['user_id' => $data['user_detail']->id])}}" class="btn btn-primary">Show more</a>
