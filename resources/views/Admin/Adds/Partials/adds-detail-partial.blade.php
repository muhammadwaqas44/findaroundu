                ...
                <ul class="all_adds_ul">
                    @foreach($data['add_detail']->gallery as $gallery)
                        <li class="">
                            ...
                            <a href="{{route('agent.delete-gallery-image-adds',[$gallery->id ])}}"><i class="fas fa-trash-alt fa-pull-right"></i></a>
                ...
                <div class="add_detail-right-main">
                    ...
                    <ul class="action-tab-ul">
                      {{--  <li>
                        ...
                        <li>
                            <a href=" {{route('agent.delete-add',$data['add_detail']->id)}}" class="create-form-btn">Delete Add</a>
