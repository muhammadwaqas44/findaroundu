...
@section('content')
    ...
    <div class="body-container">
        @include('Admin.Services.Partials.all-service-menu-partial')
                ...
                <div class="table-sec-main">
                    <div class="table-first-sec">
                        <ul class="table-left-ul">
                            ...
                            <li>
                                <a href="{{route('admin.approve-all-services')}}" class="send-main-btn"> Approve All Services</a>
                            </li>
                        </ul>
                        ...
                        <div class="start-table">
                            <div class="start-table-main">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('user.front-services.detail',[$service->id])}}">{{$service->title}}</a>
                                            </span>
                                            </div>
                                        </div>
                                ...
                                <ul class="table-icon-ul">
                                    <li><a href="{{route('user.front-services.detail',[$service->id])}}"><i
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                               ...
                                               <li> @if($service->is_approve == 'Not Approve')
                                                    ...
                                                    <a href="{{route('admin.approve-service',[$service->id])}}">Approve
                                                        Service</a>

                                                    <a href="{{route('admin.reject-service',[$service->id])}}">Reject
                                                        Service</a>
