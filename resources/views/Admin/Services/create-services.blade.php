...
@section('content')
    ...
    <div class="body-container">
        ...
        @include('Admin.Services.Partials.add-service-menu-partials')
                    ...
                    <div class="detail-tab-main">
                        ...
                        <div class="tab-content">
                            <div id="create-adds" class="tab-pane active">
                                ...
                                <form method="post" action="{{url('admin/post-service-admin')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" name="address" id="address"
                                                                   ...
                                                                   class="enter-text-field" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function getUser (data) {
            if(data != '') {
                $.ajax({
                    type: 'POST',
                    url: '{{route('admin-get-user-address')}}',
                    data: {
                        '_token': '{{csrf_token()}}',
                        'user_id': data
                    },
