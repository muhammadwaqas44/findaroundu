...
@section('content')
    ...
    <div class="body-container">
        @include('admin.Subscription.Partials.all-subscription-menu-partial')
        <div class="right-rable-main">

            <form id="form_submit_onchange" method="get"
                  action="{{route('admin.all-subscription')}}">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('admin.subscription.subscription-detail',[$fronData->id])}}">{{$fronData->name}}</a>
                                            </span>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                ...
                                                <a href="{{route('admin.plan-detail',[$fronData->plan->id])}}">{{$fronData->plan->name}}</a></span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                        class="custom-right-text">
                                                <a href="{{route('admin.user-detail',[$fronData->subscriber->id])}}">{{$fronData->subscriber->name}}</a></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                            <span class="custom-right-text">
                                                <a href="{{route('admin.user-detail',[$fronData->subscriber->id])}}">{{$fronData->subscriber->email}}</a>
                                        </span>
                                            </div>
                                        </div>
                                        <div class="row">
