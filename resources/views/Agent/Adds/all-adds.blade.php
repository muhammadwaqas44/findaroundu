...
@section('content')
    ...
    <div class="body-container">
        @include('Agent.Adds.Partials.all-add-menu-partial')
        <div class="right-rable-main">

            <form id="form_submit_onchange" method="get"
                  action="{{route('agent.all-adds')}}">
                        ...
                        <div class="start-table">
                            <div class="start-table-main">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('agent.adds.detail',[$add->id])}}">{{$add->title}}</a>
                                            </span>
                                            </div>
                                        </div>
                                ...
                                <ul class="table-icon-ul">
                                    <li><a href="{{route('agent.adds.detail',[$add->id])}}"><i
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{route('agent.delete-add',$add->id)}}">Delete Add</a></li>
                                            @if($data['settings'] != NULL)
                                                @if($data['settings']->is_adds == 1)
                                            <li>
                                                @if($add->is_approve == 'Not Approve')
                                                    <a href="{{route('agent.approve-add',[$add->id])}}">Approve
                                                        Add</a>
                                                @else
                                                    <a href="{{route('agent.approve-add',[$add->id])}}">Disapprove
                                                        Add</a>
                                                @endif
                                            </li>
                                                @endif
