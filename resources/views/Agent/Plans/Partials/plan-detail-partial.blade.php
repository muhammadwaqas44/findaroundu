                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="custom-right-text2">Restricted addons <a href="#"> Manage</a> </span>
                                <span class="custom-right-text2" style="margin-bottom: 10px;">Choose the addons applicable with this plan. If no addons are applicable, you can choose to not add any. </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6"><span class="customer-id2"></span></div>
                            <div class="col-6"><span class="custom-right-text2" style="margin-bottom: 10px;">You have not selected any applicable addons for this plan. </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6"><span class="customer-id2"></span></div>
                            <div class="col-6"><span class="custom-right-text2" style="margin-bottom: 10px;"><a
                                            href="#"> Add addons</a> </span></div>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="row">
                ...
                <div class="events-tab-main">
                    <table class="table">
                        ...
                        <tr>
                            <td><a href="javascript:void(0)">{{ $planFeature->name }}</a></td>
