...
<div id="feature_section">
            <div class="row">
                ...
                <div class="col-12 col-sm-10">
                    <input style="margin: 5px; width: auto;" type="text" placeholder="Name" name="feature_name[]" class="new-customer-input" required>
...
<div style="display: none;" id="add_features_html">
    ...
    <div class="col-12 col-sm-2"><label class="new-customer-id">Feature</label></div>
    <div class="col-12 col-sm-10">
        <input style="margin: 5px; width: auto;" type="text" name="feature_name[]" placeholder="Name" class="new-customer-input" required>
        <span style="margin: 5px; width: auto;">
                        <input style="margin: 5px; width: auto;" placeholder="Quantity" type="number" name="feature_quantity[]" class="new-customer-input" required>
                                </span>
    </div>
...
<script>
            $(document).on('click','#add_feature',function () {
             var featureHtml = $('#add_features_html').html();
             $('#feature_section').append(featureHtml);
            });
