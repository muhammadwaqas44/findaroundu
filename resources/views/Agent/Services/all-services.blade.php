    ...
    <div class="body-container">
        ...
        <div class="right-rable-main">
            ...
            <form id="form_submit_onchange" method="get"
                  action="{{route('agent.all-services')}}">
                <div class="search-drop-down-main">

                    <div class="search-left">

                        <input type="text" name="search" value="{{ old('search') }}" placeholder="By Service Name"
                               name="search">
            ...
            @if($data['all_services']['all_services_count'] > 0)
                <div class="table-sec-main">
                    ...
                    <span class="pagination-text">Showing
                        ...
                        @if($data['all_services']['total_services']->total() > 5 )
                            {{$data['all_services']['all_services']->firstItem()}}
                            - {{$data['all_services']['total_services']->lastItem()}}
                            of {{$data['all_services']['all_services_count']}}
                        ...
                        @endif  </span>
                            @if(!app('request')->input('sort_by'))
                                {{$data['all_services']['all_services']->links()}}
                            @else
                                {{$data['all_services']['all_services']->appends(['sort_by' => app('request')->input('sort_by')])->links()}}
                            @endif
                        </div>
                    </div>
                    ...
                    @foreach($data['all_services']['all_services'] as $service)
                        <div class="start-table">
                            <div class="start-table-main">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('agent.front-services.detail',[$service->id])}}">{{$service->title}}</a>
                                            </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                        class="custom-right-text">@if($service->is_active == 1)
                                                    ...
                                                    @elseif($service->is_approve == "Not Approve")
                                                        <span class="custom-right-text btn btn-warning btn-sm"> NOT APPROVE</span>
                                                    @elseif($service->is_approve == "Rejected")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                        ...
                                                        <span class="custom-right-text">Hourly Rate : {{$service->hourly_price}}
                                                            $ </span><br>

                                                        <span class="custom-right-text">Project Base Rate : {{$service->project_price}}
                                                            $ </span>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                        class="custom-right-text">{{$service->id}}</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span
                                                        class="customer-id">Location</span></div>
                                            <div class="col-md-7 col-sm-6 col-6"><span class="custom-right-text">{{$service->address->country->name}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                ...
                                                @if(!empty($service->address->address))
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">
                                                    @if(!empty($service->facebook_url) && !empty($service->gmail_url) && !empty($service->twitter_url))
                                                        {{$service->address->address}}
                                                    @else
                                                        -Not Configured-
                                                    @endif
                                ...
                                <ul class="table-icon-ul">
                                    <li><a href="{{route('agent.front-services.detail',[$service->id])}}"><i
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{route('agent.delete-service',$service->id)}}">Delete Service</a></li>
                                            @if($data['settings'] != NULL)
                                            @if($data['settings']->is_service == 1)
                                            <li> @if($service->is_approve == 'Not Approve')

                                                    <a href="{{route('agent.approve-service',[$service->id])}}">Approve
                                                        Service</a>
                                                @else

                                                    <a href="{{route('agent.approve-service',[$service->id])}}">DisApprove
                                                        Service</a>
                    ...
                    @endforeach
                    <span class="showing-text">{{$data['all_services']['all_services']->firstItem()}}
                        - {{$data['all_services']['total_services']->lastItem()}}
                        of {{$data['all_services']['all_services_count']}} </span>
                </div>
            @endif
