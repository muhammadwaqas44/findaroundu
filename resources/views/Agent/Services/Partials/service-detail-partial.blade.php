                ...
                <div class="service_detail-right-main">
                    ...
                    <ul class="action-tab-ul">
                       {{-- <li>
                        ...
                        <li>
                            <a href="{{route('agent.delete-service',$data['service_detail']->id)}} " class="create-form-btn">Delete Service</a>
...
<div class="modal" id="add-services" role="dialog" style="background: rgba(0,0,0,.9);">
    <div class="auto-collection">
        ...
        <form method="post" action="{{route('agent.add-service',[$data['service_detail']->id])}}"
...
<ul class="all_adds_ul">
    @foreach($data['service_detail']->gallery as $gallery)
        <li class="">
            ...
            <a href="{{route('agent.delete-gallery-image-services',[$gallery->id ])}}"><i class="fas fa-trash-alt fa-pull-right"></i></a>
