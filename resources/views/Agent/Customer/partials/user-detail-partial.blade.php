                    ...
                    <div class="first-sec-new-user-left2" id="collapse-div">
                        <div class="center-align">
                            <div class="ed-profile2" title="Change">
                                <img id="image_upload_preview" alt="img" src="{{$data['user_detail']->userInfo->profile_image}}">
                ...
                <div class="col-md-4 col-sm-12 remove-pad-profile">
                    <div class="first-sec-new-user-left2">
                        <ul class="job-info-ul">
                            ...
                            <li> <span class="job-info-text">Account Type <span>{{$data['user_detail']->userInfo->account_type}}</span></span> </li>
                ...
                <!-- Tab panes -->
                    <div class="tab-content">
                        ...
                        <div id="general-info" class="tab-pane active">
                            @include('Agent.Customer.partials.general-info')
                        </div>

                        <div id="business" class="tab-pane fade">
                            @include('Agent.Customer.partials.business-info')
                        </div>

                        <div id="service" class="tab-pane fade">
                            @include('Agent.Customer.partials.service-info')
                        </div>

                        <div id="adds" class="tab-pane fade">
                            @include('Agent.Customer.partials.ads-info')
                        </div>

                        <div id="subscriptions" class="tab-pane fade">
                            @include('Agent.Customer.partials.subscriptions-info')
                        </div>

                        <div id="packages" class="tab-pane fade">
                            @include('Agent.Customer.partials.package-info')
                        </div>
...
<div class="modal" id="changePasswordModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{route('agent.customer.change-password',[$data['user_detail']->id])}}">
            @csrf
