...
@section('content')
    ...
    <div class="body-container">
        @include('Agent.User.Partials.all-users-menu-partial')
        <div class="right-rable-main">

            <form id="form_submit_onchange" method="get"
                  action="{{route('agent.all-users')}}">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('agent.user-detail',[$user->id])}}">{{$user->name}}</a>
                                            </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6">
                                                <span class="customer-id">Email</span>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6">
                                                <span class="custom-right-text">
                                                    ...
                                                    Adds ({{$user->adds()->count()}})
,
                                                    Services ({{$user->services()->count()}}),
                                                    Business ({{$user->businesses()->count()}})
                                ...
                                <ul class="table-icon-ul">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('agent.delete-user',[$user->id])}}">Delete User</a>
                                            </li>
                                            @if($data['settings'] != NULL)
                                                @if($data['settings']->is_user == 1)
                                            @if($user->is_active == 1)
                                                <li><a href="{{route('agent.change-status.user',[$user->id])}}">Deactive</a></li>
                                            @else
                                                <li><a href="{{route('agent.change-status.user',[$user->id])}}">Active</a></li>
                                            @endif
                                            @endif
                                            @endif
