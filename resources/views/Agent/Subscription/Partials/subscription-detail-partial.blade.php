                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6"><span class="custom-right-text2"><a
                                            href="{{route('agent.user-detail',[$data['subscription_detail']->user->id])}}">{{$data['subscription_detail']->user->email}}</a></span>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-6 "><span
                                    ...
                                    <a href="{{--{{route('agent.plan-detail',[$data['subscription_detail']->plan->id])}}--}}">{{$data['subscription_detail']->plan->name}}</a>
                                </span>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6  "><span
                                   ...
                                   @if(!empty($data['subscription_detail']->user->billingInfo)) present @endif <a
                                           >@if(!empty($data['subscription_detail']->user->billingInfo))
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6"><span
                                        class="custom-right-text2">
                                    <a href="{{route('agent.plan-detail',[$data['subscription_detail']->plan->id])}}">{{$data['subscription_detail']->plan->planFeatures->first()->quantity}}</a>
                                </span>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6"><span class="customer-id2">MRR</span></div>
                            <div class="col-6"><span
                      ""                  class="custom-right-text2">
                                    <a href="{{route('agent.plan-detail',[$data['subscription_detail']->plan->id])}}">{{$data['subscription_detail']->plan->name}}</a>
                                </span>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->first_name}}</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6"><span class="customer-id2">Last name</span></div>
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->last_name}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6"><span class="customer-id2">Email</span></div>
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->email}}</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6"><span class="customer-id2">Phone</span></div>
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->phone}}</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6"><span class="customer-id2">Address</span></div>
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->address}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->city}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->zip}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6"><span
                                            class="custom-right-text2">{{$data['subscription_detail']->user->billingInfo->state}}</span>
                                </div>
                            </div>
                                    ...
                                    @if($data['subscription_detail']->invoices()->count() == 0)
                                        ...
                                        @foreach($data['subscription_detail']->invoices as $invoice)
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>{{$invoice->id}}</td>
                                                    <td><a href="{{route('main-admin.invoice-detail',[$invoice->id])}}">{{$invoice->invoice_name}}</a></td>
                ...
                <div class="tab-content">
                    <div id="Actions" class="container tab-pane active"><br>
                        <ul class="action-tab-ul">
                            ...
                            <li>
                                <a href="{{route('agent.user-detail',[$data['subscription_detail']->user->id])}}"
