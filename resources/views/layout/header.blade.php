    ...
    <div class="container top-search-main">
        <div class="row">
            <div class="ts-menu">
                <!--SECTION: LOGO-->
                <div class="ts-menu-1">
                    <a href="index-1.html"><img src="{{'project-assets/images/aff-logo.png'}}" alt=""> </a>
                </div>
