<script>
    function getReviews(id) {
        baseUrl = null;
            @if($data['flag'] == 'Service'){
            baseUrl = "{{url('user/service/')}}" + "/" + id + "/reviews";
        }
        @endif
        ...
        $.get(baseUrl, function (data, status) {
            ...
            if (data.reviews != null) {
                ...
                for (i = 0; i < data.reviews.length; i++) {
                    ...
                    likeHtml = `<li><a id="like-color-` + data.reviews[i].review_id + `" ` + likeColor + `  onclick="addLike(` + data.reviews[i].review_id + `)"><span ` + likeColor + `>Like (<span id="like_count_post_` + data.reviews[i].review_id + `">` + data.reviews[i].review_likes +`</span>)</span><i class="fas fa-thumbs-up" aria-hidden="true"></i></a> </li>`;
                    commentHtml = `<li><a onclick="loadComments(` + data.reviews[i].review_id + `)" data-toggle="collapse" data-target="#coment-` + data.reviews[i].review_id + `"><span>Comments (<span id="comment_count_post_` + data.reviews[i].review_id + `">` + data.reviews[i].reviews_comments_count +`</span>)</span> <i class="fa fa-commenting-o" aria-hidden="true"></i><i class="far fa-comment-dots"></i></a> </li>`;
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                     ...
                     <ul class="next-ul" style="margin-top: 15px !important;">` + likeHtml + commentHtml + `
