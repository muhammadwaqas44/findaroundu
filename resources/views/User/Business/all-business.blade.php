                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="row">
                                            ...
                                            <span class="custom-right-text">
                                                <a href="{{route('user.business.detail',[$business->id])}}">{{$business->title}}</a>
                                            </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span class="custom-right-text">
                                                    {{$business->address->first()->country->name}} , {{$business->address->first()->city->name}}
                                         </span></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5 col-sm-6 col-6"><span class="customer-id">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-6"><span
                                                        class="custom-right-text">
                                                @if(!empty($business->address->first()->address))
                                                        {{$business->address->first()->address}}
                                                    @else
                                                        -Not Configured-
                                                    @endif
                                            </span>
...
<label class="badge badge-info" style="margin-right:5px;">{{$category->name}}</label>
                                ...
                                <ul class="table-icon-ul">
                                    <li><a href="{{route('front-business.detail',[$business->id])}}"><i class="far fa-eye" title="view details"></i></a></li>
                                    <li class="dropdown">
                                        <a href="#" data-toggle="dropdown" aria-expanded="true" title="actions"><i
                                                    class="fas fa-cog"></i> <i class="fas fa-caret-down"></i></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('user.delete-business',[$business->id])}}">Delete Business</a></li>
                                            @if($business->is_active == 1)
                                            <li><a href="{{route('user.change-status.business',[$business->id])}}">DeActive Business</a></li>
                                            @else
                                                <li><a href="{{route('user.change-status.business',[$business->id])}}">Active Business</a></li>
                                                @endif
