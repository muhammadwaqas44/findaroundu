    ...
    <div class="row">
        <div class="col-md-12 col-lg-8">
            ...
            <ul class="all_adds_ul">
                @foreach($data['business']->gallery as $gallery)
                    <li class="">
                        <img src="{{ $gallery->name }}" >
                        <a href="{{route('user.delete-gallery-image-business',[$gallery->id ])}}"><i class="fas fa-trash-alt fa-pull-right"></i></a>
                    </li>
                @endforeach
            </ul>
                ...
                <div class="business-right-main">
                    ...
                    <ul class="action-tab-ul">
                       {{-- <li>
                        ...
                        @if($data['business']->is_active == 0)
                        <li>
                            <a href="{{route('user.change-status.business',[$data['business']->id])}} " class="create-form-btn">Active Business</a>
                            <span class="create-form-content">Active this business</span>
                        </li>
                        @else
                        <li>
                            <a href=" {{route('user.change-status.business',[$data['business']->id])}}" class="create-form-btn">Deactive Business</a>
                            <span class="create-form-content">Deactivate this business</span>
                        </li>
                        @endif
                        <li>
                            <a href=" " class="create-form-btn">Delete Business</a>
                            <span class="create-form-content">Delete this business. No new subscriptions can be created using this business.</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="modal" id="add-services" role="dialog" style="background: rgba(0,0,0,.9);">
    <div class="auto-collection">
        ...
        <form method="post" action="{{route('user.add-services',[$data['business']->id])}}"
