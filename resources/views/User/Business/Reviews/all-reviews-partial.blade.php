            ...
            <div class="col-12">
                @if(Auth::check())
                    <form method="post" action="{{route('user.give-review')}}">
                        ...
                        <input name="business_id" value="{{$data['business_detail']->id}}" style="display:none;">
                            ...
                            <li>
                                <div class="rating-last-div transparent-bg clearfix">
                                    ...
                                    <div class="rating-last-right">
                                        <span>{!! \App\Helpers\ReviewHelper::reviewStars($data['business_detail']) !!}</span>
...
@include('User.Business.Reviews.Partials.reviews-js-partial')


<script>

    getReviews({{$data['business_detail']->id}});
