...
@section('content')
    ...
    <div class="body-container">
        @include('User.Inv.Products.Partials.all-products-menu-partial')
        <div class="right-rable-main">
            ...
            @if($data['all_products']['all_products_count'] > 0)
                <div class="table-sec-main">
                    ...
                    <span class="pagination-text">Showing
                        ...
                        @if($data['all_products']['total_pages']->total() > 5 )
                            {{$data['all_products']['all_products']->firstItem()}}
                            - {{$data['all_products']['total_pages']->lastItem()}}
                            of {{$data['all_products']['all_products_count']}}
                        ...
                        @endif  </span>
                            @if(!app('request')->input('sort_by'))
                                {{$data['all_products']['all_products']->links()}}
                            @else
                                {{$data['all_products']['all_products']->appends(['sort_by' => app('request')->input('sort_by')])->links()}}
                            @endif
                        </div>
                    </div>
                    ...
                    @foreach($data['all_products']['all_products'] as $add)
                    ...
                    @endforeach
                    <span class="showing-text">{{$data['all_products']['all_products']->firstItem()}}
                        - {{$data['all_products']['total_pages']->lastItem()}}
                        of {{$data['all_products']['all_products_count']}} </span>
                </div>
            @endif
